...
namespace biNUICLeAR
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            Texture2D[] allTextures = new Texture2D[26];
            ...
            allTextures[8] = Content.Load<Texture2D>("Graphics\\blood2grave2");
            allTextures[9] = Content.Load<Texture2D>("Graphics\\chaseenemy.png");
            allTextures[10] = Content.Load<Texture2D>("Graphics\\block1");
            allTextures[11] = Content.Load<Texture2D>("Graphics\\block2");
            allTextures[12] = Content.Load<Texture2D>("Graphics\\block3");
            allTextures[13] = Content.Load<Texture2D>("Graphics\\block4");
            allTextures[14] = Content.Load<Texture2D>("Graphics\\block5");
            allTextures[15] = Content.Load<Texture2D>("Graphics\\block6");
            allTextures[16] = Content.Load<Texture2D>("Graphics\\block7");
            allTextures[17] = Content.Load<Texture2D>("Graphics\\block8");
            allTextures[18] = Content.Load<Texture2D>("Graphics\\block9");
            allTextures[19] = Content.Load<Texture2D>("Graphics\\block10");
            allTextures[20] = Content.Load<Texture2D>("Graphics\\block11");
            allTextures[21] = Content.Load<Texture2D>("Graphics\\block12");
            allTextures[22] = Content.Load<Texture2D>("Graphics\\block13");
            allTextures[23] = Content.Load<Texture2D>("Graphics\\block14");
            allTextures[24] = Content.Load<Texture2D>("Graphics\\block15");
            allTextures[25] = Content.Load<Texture2D>("Graphics\\block16");
